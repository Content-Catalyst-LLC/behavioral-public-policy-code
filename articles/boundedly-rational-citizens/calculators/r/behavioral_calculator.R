#!/usr/bin/env Rscript
# Self-contained behavioral calculator for From Rational Citizens to Boundedly Rational Citizens
...
result <- data.frame(
  series = "Behavioral Public Policy",
  article = "From Rational Citizens to Boundedly Rational Citizens",
